...
public class GlobalValues {
    ...
    public static final String WELCOME_BODY = "A simple note app for all your text storage needs."
            + "\n\nThis is a beta release. Please feel free to submit any issues or questions "
            + "to gilera.ryan@gmail.com."
            + "\n\nFEATURES:"
            + "\n1. Create, edit, and delete notes."
            + "\n2. Search and filter notes easily."
            + "\n3. Single touch edit - allowing you to initiate edit easily. Simply "
            + "tap on the location of the text you would like to edit."
            + "\n4. Allows font size change."
            + "\n5. Support for large screen and tablet devices."
            + "\n6. Share your notes to your favourite apps."
            + "\n7. And save notes from your favourite apps (if share enabled)."
